print("^2Simotsu-Hunting Enhanced ^7v^4"..GetResourceMetadata(GetCurrentResourceName(), 'version', nil):gsub("%.", "^7.^4").."^7 - ^2vorp_hunting enhanced script by ^1Simotsu^7")
...
Config = {}
--New Configs
Config.PeltLevelSystem = true --true if you want Payment of pelts to go up per hunting level
Config.CarcassLevelSystem = true --true if you want Payment of carcasses to go up per hunting level
Config.BaitLevelSystem = true --true if you want bait to only be able to be used based on levels outlined in readme.

Config.BaitCooldownTimer = 60000 --1 minute in miliseconds | How often you can place bait
Config.CannotPlaceInTown = true --true if you do not want baits to be placed in towns.
Config.AnimalSpawnTimer = 10 --How quickly the animal appears after placing bait. 15 seconds in miliseconds

Config.ItemToUse = { --items to be used for bait and their types
    {
      Name = "consumable_predator_bait",
      ProvisionType = 'PREDATOR_BAIT',
    },
    {
      Name = 'consumable_potent_predator_bait', -- Item name
      ProvisionType = 'POTENT_PREDATOR_BAIT',
    },
    {
      Name = 'consumable_potent_herbivore_bait', -- Item name
      ProvisionType = 'POTENT_HERBIVORE_BAIT',
    },
    {
      Name = 'consumable_herbivore_bait', -- Item name
      ProvisionType = 'HERBIVORE_BAIT',
    },
    {
      Name = 'consumable_legendary_bait', -- Item name
      ProvisionType = 'LEGENDARY_BAIT',
    },
}
    --Bait Configs--
    Config.PotentHerbivoreBaitAnimals = {
            "a_c_bighornram_01",
            "a_c_pronghorn_01",
    }

    Config.HerbivoreBaitAnimals = {
        "a_c_boar_01",
        "a_c_duck_01",
        "a_c_goat_01",
        "a_c_sheep_01",
    ...
    Config.PotentPredatorBaitAnimals = {
        "a_c_bearblack_01",
        "a_c_alligator_01",
        "a_c_cougar_01",
        "a_c_panther_01",
    ...
    Config.LegendaryBait = {
        "A_C_Alligator_02", --White Alligatore
        "A_C_Buffalo_Tatanka_01", -- Buffalo Tatanka
        "A_C_Javelina_01", --White Pig Javelina
        "A_C_BoarLegendary_01", --huge Boar
        "A_C_Elk_01", --Black Elk
        "A_C_Cougar_01", --White Cougar
        "A_C_Moose_01", --White Alligatore
        "a_c_beaver_01",
    }

Config.BirdBaitAnimals = {
    "a_c_crow_01",
    "a_c_chickenhawk_01",
    "a_c_eagle_01",
    "a_c_vulture_01",
...
-----------------OLDER CONFIG THINGS-----------------------
Config.DevMode = false        -- DISABLE THIS IF YOUR SERVER IS LIVE
...
Config.Animals = {
    -- Animals This is where the money comes from
    [-1124266369]  = { name = "Bear", givenItem = { "meat" }, givenAmount = { 0 }, money = 15.0, gold = 0, rolPoints = 0, xp = 6, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 957520252, good = 143941906, perfect = 1292673537 },
    [-15687816381] = { name = "Big Horn Ram", givenItem = { "meat" }, givenAmount = { 0 }, money = 6.0, gold = 0, rolPoints = 0, xp = 3, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1796037447, good = -476045512, perfect = 1795984405 },
    [2028722809]   = { name = "Boar", givenItem = { "meat" }, givenAmount = { 0 }, money = 3.0, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1248540072, good = nil, perfect = -1858513856 },
    [-1963605336]  = { name = "Buck", givenItem = { "meat" }, givenAmount = { 0 }, money = 5.0, gold = 0, rolPoints = 0, xp = 3, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1603936352, good = -868657362, perfect = -702790226 },
    [1556473961]   = { name = "Bison", givenItem = { "meat" }, givenAmount = { 0 }, money = 5.0, gold = 0, rolPoints = 0, xp = 3, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = -1730060063, good = -591117838, perfect = -237756948 },
    [1957001316]   = { name = "Bull", givenItem = { "meat" }, givenAmount = { 0 }, money = 4.5, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 9293261, good = -336086818, perfect = -53270317 },
    [1110710183]   = { name = "Deer", givenItem = { "meat" }, givenAmount = { 0 }, money = 4.0, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = -662178186, good = -1827027577, perfect = -1035515486 },
    [-1003616053]  = { name = "Duck", givenItem = { "feathers" }, givenAmount = { 0 }, money = 3.0, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [1459778951]   = { name = "Eagle", givenItem = { "feathers" }, givenAmount = { 0 }, money = 6.0, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [831859211]    = { name = "Egret", givenItem = { "feathers" }, givenAmount = { 0 }, money = 3.0, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-2021043433]  = { name = "Elk", givenItem = { "meat" }, givenAmount = { 0 }, money = 5.5, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 2053771712, good = 1181652728, perfect = -1332163079 },
    [252669332]    = { name = "American Red Fox", givenItem = { "meat" }, givenAmount = { 0 }, money = 4.0, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1647012424, good = 238733925, perfect = 500722008 },
    [-1143398950]  = { name = "Big Grey Wolf", givenItem = { "meat" }, givenAmount = { 0 }, money = 5.0, gold = 0, rolPoints = 0, xp = 3, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 85441452, good = 1145777975, perfect = 653400939 },
    [-885451903]   = { name = "Medium Grey Wolf", givenItem = { "meat" }, givenAmount = { 0 }, money = 4.5, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 85441452, good = 1145777975, perfect = 653400939 },
    [-829273561]   = { name = "Small Grey Wolf", givenItem = { "meat" }, givenAmount = { 0 }, money = 4.0, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 85441452, good = 1145777975, perfect = 653400939 },
    [1104697660]   = { name = "Vulture", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2.75, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-407730502]   = { name = "Snapping Turtle", givenItem = { "meat" }, givenAmount = { 0 }, money = 1.75, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-466054788]   = { name = "Wild Turkey", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-2011226991]  = { name = "Wild Turkey", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-166054593]   = { name = "Wild Turkey", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-22968827]    = { name = "Water Snake", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-1790499186]  = { name = "Snake Red Boa", givenItem = { "meat" }, givenAmount = { 0 }, money = 3, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    ...
    [846659001]    = { name = "Black-Tailed Rattlesnake", givenItem = { "meat" }, givenAmount = { 0 }, money = 2.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [545068538]    = { name = "Western Rattlesnake", givenItem = { "meat" }, givenAmount = { 0 }, money = 2.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-121266332]   = { name = "Striped Skunk", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [40345436]     = { name = "Merino Sheep", givenItem = { "wool" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1729948479, good = -1317365569, perfect = 146620167 },
    [-164963696]   = { name = "Herring Seagull", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-1076508705]  = { name = "Roseate Spoonbill", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [2023522846]   = { name = "Dominique Rooster", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-466687768]   = { name = "Red-Footed Booby", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1.95, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-575340245]   = { name = "Wester Raven", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [1458540991]   = { name = "North American Racoon", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-541762431]   = { name = "Black-Tailed Jackrabbit", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    ...
    [2079703102]   = { name = "Greater Prairie Chicken", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-1414989025]  = { name = "Virginia Possum", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [1007418994]   = { name = "Berkshire Pig", givenItem = { "meat" }, givenAmount = { 0 }, money = 1.75, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = -308965548, good = -57190831, perfect = -1102272634 },
    [1416324601]   = { name = "Ring-Necked Pheasant", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1.25, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [1265966684]   = { name = "American White Pelican", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    ...
    [1654513481]   = { name = "Panther", givenItem = { "meat" }, givenAmount = { 0 }, money = 14, gold = 0, rolPoints = 0, xp = 5, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 284468323, good = -395646254, perfect = 1969175294 },
    [120598262]    = { name = "Californian Condor", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-2063183075]  = { name = "Dominique Chicken", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-2073130256]  = { name = "Double-Crested Cormorant", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [90264823]     = { name = "Cougar", givenItem = { "meat" }, givenAmount = { 0 }, money = 11, gold = 0, rolPoints = 0, xp = 4, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1914602340, good = 459744337, perfect = -1791452194 },
    [-50684386]    = { name = "Florida Cracker Cow", givenItem = { "feathers" }, givenAmount = { 0 }, money = 1, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 334093551, good = 120594075, perfect = -845037222 },
    ...
    [-564099192]   = { name = "Whooping Crane", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [45741642]     = { name = "Gila Monster", givenItem = { "meat" }, givenAmount = { 0 }, money = 3, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-753902995]   = { name = "Alpine Goat", givenItem = { "meat" }, givenAmount = { 0 }, money = 2.50, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 699990316, good = 171071442, perfect = -1648383828 },
    [723190474]    = { name = "Canada Goose", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-2145890973]  = { name = "Ferruinous Hawk", givenItem = { "feathers" }, givenAmount = { 0 }, money = 3, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [1095117488]   = { name = "Great Blue Heron", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2.5, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-1854059305]  = { name = "Green Iguana", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-593056309]   = { name = "Desert Iguana", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [1751700893]   = { name = "Peccary Pig", givenItem = { "meat" }, givenAmount = { 0 }, money = 1, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = -99092070, good = -1379330323, perfect = 1963510418 },
    [386506078]    = { name = "Common Loon", givenItem = { "feathers" }, givenAmount = { 0 }, money = 2.25, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-1098441944]  = { name = "Moose", givenItem = { "meat" }, givenAmount = { 0 }, money = 8.5, gold = 0, rolPoints = 0, xp = 4, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1868576868, good = 1636891382, perfect = -217731719 },
    [-1134449699]  = { name = "American Muskrat", givenItem = { "meat" }, givenAmount = { 0 }, money = 2.25, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [-86244272]    = { name = "Great Horned Owl", givenItem = { "feathers" }, givenAmount = { 0 }, money = 3.25, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = nil, good = nil, perfect = nil },
    [556355544]    = { name = "Angus Ox", givenItem = { "meat" }, givenAmount = { 0 }, money = 2, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 4623248928, good = 1208128650, perfect = 659601266 },
    [-1892280447]  = { name = "Alligator Small", givenItem = { "BigGameMeat" }, money = 3, gold = 0, rolPoints = 0, xp = 1, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 180623689, good = -802026654, perfect = -1625078531 },
    [-2004866590]  = { name = "Alligator", givenItem = { "BigGameMeat" }, money = 4, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 3, poor = -1243878166, good = nil, perfect = -1475338121 },
    [759906147]    = { name = "North American Beaver", givenItem = { "meat" }, givenAmount = { 0 }, money = 3.16, gold = 0, rolPoints = 0, xp = 2, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = -269450319, good = -2059726619, perfect = 854596618 },
    [730092646]    = { name = "American Black Bear", givenItem = { "meat" }, givenAmount = { 0 }, money = 8, gold = 0, rolPoints = 0, xp = 4, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1083865179, good = 1490032862, perfect = 663376218 },
    -- Fish
